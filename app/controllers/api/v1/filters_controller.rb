class Api::V1::FiltersController < ApplicationController
  ...
  def index
    ...
    render json: {users: @users_simple, clients: @clients, projects: @projects, workflows: @workflows, task_names: @task_names, task_states: @task_states, task_dates: @task_dates, jobs: @jobs}
